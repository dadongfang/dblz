        ...
        me = function e(t) {
          ...
          S(this, e),
            ...
            (this.kill = function (e) {
              ...
              'number' === typeof e
                ? (n.paused(),
                  ...
                  n.paused(!1))
                : ((n.children = []),
                  null === (t = n.parent) || void 0 === t || t.removeChild(n));
            }),
            ...
            (this.render = function (e) {
              ...
              if (!(M < -a)) {
                var k = M < 0 ? 0 : M;
                (k = k > i ? i : k), (k = v < y ? M : k), (k = v > o ? v : k);
                var j = O ? Math.floor(k / (l + S)) : 0;
                j = O && j > O ? O : j;
                var P = k - (l + S) * j,
                  A = !!(T && j % 2);
                (P = A ? l - P : P), (P = y + P);
                ...
                if (
                  ...
                  'number' !== typeof b && (n.mode = 'onTimelineStart'),
                  k >= o - E &&
                    'number' === typeof b &&
                    (n.mode = 'onTimelineComplete'),
                  j !== n.repeatNum &&
                    ((n.mode = 'onTimelineRepeat'), k > s * j && k < s * j + a))
                ) {
                  for (var _ = c.length - 1; _ >= 0; _--) {
                    var D = c[_];
                    L || (D.prevMoment = void 0),
                      D.render({ moment: L ? D.totalTime : 0, fps: a });
                  }
                  h({
                    moment: k,
                    totalTime: i,
                ...
                for (var I = 0; I < c.length; I++) {
                  var N = c[I],
                    z = N.totalTime + N.appearTo,
                    F = P >= N.appearTo - a && P < z + a;
                  if (
                    ('onComplete' !== N.mode &&
                      P > z + a &&
                      !A &&
                    ...
                    var R = P < 0 ? 0 : P;
                    if (P > z && 'onComplete' === N.mode && !A) return;
                    (R = P > z ? z : P),
                      N.render({ moment: R - N.appearTo, fps: a }),
                      z ||
                ...
                h({
                  ...
                  (f ||
                    ...
                    (p && M + E <= 0) ||
                    !c.length) &&
                    (null === m || void 0 === m || m.removeChild(n));
              }
            });
          var r = this.props,
            a = r.paused,
    ...
    aT0f: function (e, t, n) {
      ...
      V ||
        ((_ = function () {
          ...
          return i && Y && X(H, e, { configurable: !0, set: t }), U(e);
        }),
    ...
    xqva: function (e, t, n) {
      ...
      var E = Object(r['forwardRef'])(function (e, t) {
        ...
        function ie() {
          return U.virtual
            ? b(B.current, J, _)
            : !U.loop || (B.current && B.current.destroyed)
            ? J.map(function (e) {
